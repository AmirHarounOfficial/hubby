  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Extract store IDs from existing platform products
        const linkedStoreIds = product.platform_products?.map((pp: any) => pp.store_id) || [];
        setSelectedStores(linkedStoreIds);
