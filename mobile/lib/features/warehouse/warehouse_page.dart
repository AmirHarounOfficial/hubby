        ...
        child: ListView(
          ...
          children: [
            ...
            _Tile(
              ...
              title: context.t('warehouse.pick'),
              subtitle: context.t('warehouse.pickSub'),
              onTap: () => context.push('/warehouse/pick'),
            ),
            _Tile(
              icon: LucideIcons.package,
              title: context.t('warehouse.pack'),
              subtitle: context.t('warehouse.packSub'),
              onTap: () => context.push('/warehouse/pack'),
            ),
            _Tile(
              icon: LucideIcons.clipboardCheck,
              title: context.t('warehouse.count'),
              subtitle: context.t('warehouse.countSub'),
              onTap: () => context.push('/warehouse/count'),
            ),
          ],
        ),
      ),
