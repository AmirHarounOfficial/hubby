...
/// Friendly empty-state: a tinted icon, a title and a hint. Beats a bare
/// centred line of text (design + a11y).
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Icon(icon, color: AppPalette.mutedForeground, size: 26),
            ),
            ...
            if (subtitle != null) ...[
              ...
              Text(subtitle!, textAlign: TextAlign.center,
                  style: const TextStyle(color: AppPalette.mutedForeground, fontSize: 13, height: 1.4)),
            ],
          ],
        ),
      ),
